...
\hypersetup{
  pdftitle={Confiabilidade e Manutenção},
...
\title{Confiabilidade e Manutenção}
\usepackage{etoolbox}
\makeatletter
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, arc=.35mm, opacityback=0, breakable, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Pronto para começar?}, breakable, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, colback=white, coltitle=black, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, rightrule=.15mm, left=2mm, colframe=quarto-callout-tip-color-frame]
...
\pandocbounded{\includegraphics[keepaspectratio]{chapters/../images/fig-categorias-horas.png}}
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Legenda das Categorias de Horas}, breakable, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, colback=white, coltitle=black, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, rightrule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame]
...
sejam independentes entre si. De acordo com Kang et al. (2016), há dois
tipos básicos de relacionamento, o primeiro dado pela relação de
identidade dos ICDs, baseado em suas definições e, o outro, é a
relevância com elementos de suporte compartilhados que podem ser obtidos
por comparação aos pares e/ou por agrupamentos em níveis.
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Interpretação das Perdas}, breakable, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, colback=white, coltitle=black, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, rightrule=.15mm, left=2mm, colframe=quarto-callout-important-color-frame]
...
Figura 1 -- Gráfico de horas calendário: mostra as 10 categorias de
horas para um total CH = 315.360, referente aos 36 caminhões. Em
particular, podemos analisar as categorias referentes à manutenção: HMC
= 28.023; HAC = 2.771; MPS = 26.966; MPNS = 10.166.

\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{chapters/../images/Figura08_artigo_horas.png}

Figura 2 -- Exemplo de teste de referência cruzada.
\includegraphics[width=0.4\linewidth,height=\textheight,keepaspectratio]{chapters/../images/Figura08_artigo_horas.png}
...
Figura 3 -- Build-up das perdas de produção por indicador: apresenta a
representatividade em toneladas de cada fonte de perda.

\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{chapters/../images/Figura9_artigo_buildup.png}
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Continue Aprendendo}, breakable, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, colback=white, coltitle=black, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, rightrule=.15mm, left=2mm, colframe=quarto-callout-tip-color-frame]
...
Kang, Ning, Chuan Zhao, Jing Li, e J. A. Horst. 2016. {``A Hierarchical
structure of key performance indicators for operation management and
continuous improvement in production systems''}. \emph{International
Journal of Production Research} 54 (21): 6333--50.
\url{https://doi.org/10.1080/00207543.2015.1136082}.
