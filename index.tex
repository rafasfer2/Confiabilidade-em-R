...
\begin{tcolorbox}[enhanced jigsaw, colback=white, left=2mm, breakable, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, arc=.35mm, opacityback=0, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Pronto para começar?}, arc=.35mm, toprule=.15mm, opacityback=0, leftrule=.75mm, coltitle=black]
...
\tightlist
\item
  \textbf{Figuras:} Figure~\ref{fig-weibull}
\item
  \textbf{Tabelas:} Table~\ref{tbl-mtbf}
\item
...
O ciclo operacional de carregamento e transporte na mineração é composto
por diversas etapas sequenciais que se repetem continuamente. A
Figure~\ref{fig-ciclo-processos} ilustra este ciclo, que envolve as
...
\tightlist
\item
  \textbf{Carregamento}: Equipamento de carga (escavadeira ou
  carregadeira) enche a caçamba do caminhão
\item
  \textbf{Transporte carregado}: Caminhão desloca-se até o ponto de
  descarga
\item
  \textbf{Descarga}: Basculamento da caçamba no britador ou pilha
\item
  \textbf{Retorno vazio}: Caminhão retorna à frente de carregamento
\item
  \textbf{Fila}: Aguardo para novo carregamento (quando necessário)
\end{enumerate}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, toprule=.15mm, opacityback=0, leftrule=.75mm, coltitle=black]
...
\subsection{Apto para Operação}\label{apto-para-operauxe7uxe3o}

A equipe de \textbf{operação} é responsável e está focada no ciclo dos
processos de carregamento e transporte. Seu principal desafio reside na
seleção e dimensionamento dos equipamentos. Segundo {[}22{]}, isso está
relacionada à seleção e dimensionamento adequado dos equipamentos de
carregamento e transporte para realizar a tarefa de manuseio de
materiais de forma ideal durante a operação da mina e, resultando a
melhoria do indicador produtividade.

\subsection{Liberado pela
Manutenção}\label{liberado-pela-manutenuxe7uxe3o}

Este status é o momento imediatamente posterior à execução da
manutenção, e consiste na \textbf{transição de responsabilidade} da
equipe de manutenção para equipe de operação. Um acordo nível de serviço
(ANS) entre as equipes deve ser pré-estabelecido para uma eficiente
transição.

\subsection{Em Manutenção}\label{em-manutenuxe7uxe3o}

Esta é uma atividade de responsabilidade da \textbf{equipe de
manutenção} e incluem funções e processos de planejamento, inspeção,
programação e confiabilidade.

\subsection{Parada Operacional}\label{parada-operacional}

Grandes paradas são planejadas e gerenciadas considerando as
contingências necessárias. Apesar de pertencer à equipe de operação, o
\textbf{planejamento} é realizado pela gerência e considerando todo a
cadeia produtiva.

\section{Elementos de Suporte}\label{sec-elementos-suporte}
...
Em todos os níveis a soma das categorias representam as \textbf{horas
calendário} (HC), por exemplo, temos que:

\[
HC = HT + HM + HO
\]

\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Legenda das Categorias de Horas}, arc=.35mm, toprule=.15mm, opacityback=0, leftrule=.75mm, coltitle=black]
...
Desta forma, ao agrupar as categorias de horas em dia, semana, mês ou
ano, o valor nominal será dado pela soma da duração de todos os
apontamentos, cuja razão esteja configurada para contabilizar esta
categoria. Como o principal produto do ciclo de transporte é a
\textbf{massa transportada (MT)}, este configura-se como elemento
quantitativo.
...
sejam independentes entre si. De acordo com {[}23{]}, há dois tipos
...
A Figure~\ref{fig-ciclo-processos} apresenta um exemplo das relações de
status de equipamento e elementos de suporte, retirado dos dados em
estudo. Em contrário às análises teóricas das relações, é possível
observar outras ligações com as categorias de horas, estas que
representam o segundo tipo básico de relacionamento.
...
\NormalTok{dados }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Indicador =} \FunctionTok{c}\NormalTok{(}\StringTok{"Horas Calendário (HC)"}\NormalTok{, }\StringTok{"Horas Manutenção (HM)"}\NormalTok{,}
                \StringTok{"Horas Disponíveis (HD)"}\NormalTok{, }\StringTok{"Horas Ociosas (HO)"}\NormalTok{,}
                \StringTok{"Horas Trabalhadas (HT)"}\NormalTok{, }\StringTok{"Massa Transportada (MT)"}\NormalTok{),}
...
\NormalTok{icds }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Indicador =} \FunctionTok{c}\NormalTok{(}\StringTok{"Disponibilidade Física (DF)"}\NormalTok{,}
                \StringTok{"Utilização Física (UF)"}\NormalTok{,}
                \StringTok{"Produtividade (PR)"}\NormalTok{),}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{kable}\NormalTok{(perdas, }\AttributeTok{caption =} \StringTok{"Análise de Perda de Produção"}\NormalTok{,}
      \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Tipo de Perda"}\NormalTok{, }\StringTok{"Cálculo"}\NormalTok{, }\StringTok{"Perda (t)"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{bootstrap\_options =} \FunctionTok{c}\NormalTok{(}\StringTok{"striped"}\NormalTok{, }\StringTok{"hover"}\NormalTok{), }\AttributeTok{full\_width =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Interpretação das Perdas}, arc=.35mm, toprule=.15mm, opacityback=0, leftrule=.75mm, coltitle=black]
...
N. C. N. M. Branco, and R. M. de N. Luz, {``Quality assessment of
...
\emph{Revista Produção Online}, vol. 22, no. 2, pp. 2731--2762, 2023,
doi:
\href{https://doi.org/10.14488/1676-1901.v22i2.4661}{10.14488/1676-1901.v22i2.4661}.}

\bibitem[\citeproctext]{ref-osanloo2020}
\CSLLeftMargin{{[}9{]} }%
\CSLRightInline{M. Osanloo and M. Paricheh, {``In-pit crushing and
...
Reclamation and Environment}, vol. 34, no. 6, pp. 430--457, 2020, doi:
...
control management: Implementation guide.''} 2015. Available:
...
\CSLLeftMargin{{[}13{]} }%
\CSLRightInline{R. Pascual, R. Madariaga, G. Santelices, D. Godoy, and
E. L. Droguett, {``A structured methodology to optimise throughput of
production lines,''} \emph{International Journal of Mining, Reclamation
and Environment}, vol. 30, no. 1, pp. 25--36, 2016, doi:
\href{https://doi.org/10.1080/17480930.2014.962235}{10.1080/17480930.2014.962235}.}

\bibitem[\citeproctext]{ref-qiao2017}
\CSLLeftMargin{{[}14{]} }%
\CSLRightInline{G. Qiao, C. Schlenoff, and B. A. Weiss, {``Quick
positional health assessment for industrial robot prognostics and health
management (PHM),''} in \emph{2017 IEEE international conference on
robotics and automation (ICRA)}, 2017.}

\bibitem[\citeproctext]{ref-slack2013}
\CSLLeftMargin{{[}15{]} }%
\CSLRightInline{N. Slack, S. Chambers, R. Johnston, and A. Betts,
\emph{Gerenciamento de operações e de processos: Princípios e práticas
de impacto estratégico}, 2nd ed. Bookman Editora, 2013. Available:
...
55002:2018}, 2nd ed. 2019. Available:
...
\CSLLeftMargin{{[}17{]} }%
\CSLRightInline{L. Doyen and O. Gaudoin, {``Classes of imperfect repair
models based on reduction of failure intensity or virtual age,''}
\emph{Reliability Engineering \& System Safety}, vol. 84, no. 1, pp.
45--56, 2004, doi:
\href{https://doi.org/10.1016/S0951-8320(03)00173-X}{10.1016/S0951-8320(03)00173-X}.}

\bibitem[\citeproctext]{ref-gilardoni2007}
\CSLLeftMargin{{[}18{]} }%
\CSLRightInline{G. L. Gilardoni and E. A. Colosimo, {``Optimal
maintenance time for repairable systems,''} \emph{Journal of Quality
Technology}, vol. 39, no. 1, pp. 48--53, 2007, doi:
\href{https://doi.org/10.1080/00224065.2007.11917672}{10.1080/00224065.2007.11917672}.}

\bibitem[\citeproctext]{ref-toledo2016}
\CSLLeftMargin{{[}19{]} }%
\CSLRightInline{M. L. G. de Toledo, M. A. Freitas, E. A. Colosimo, and
G. L. Gilardoni, {``Optimal periodic maintenance policy under imperfect
repair: A case study on the engines of off-road vehicles,''} \emph{IIE
Transactions}, vol. 48, no. 8, pp. 747--758, 2016, doi:
\href{https://doi.org/10.1080/0740817X.2016.1147663}{10.1080/0740817X.2016.1147663}.}

\bibitem[\citeproctext]{ref-gilardoni2016}
\CSLLeftMargin{{[}20{]} }%
\CSLRightInline{G. L. Gilardoni, M. L. G. de Toledo, M. A. Freitas, and
E. A. Colosimo, {``Dynamics of an optimal maintenance policy for
imperfect repair models,''} \emph{European Journal of Operational
Research}, vol. 248, no. 3, pp. 1104--1112, 2016, doi:
\href{https://doi.org/10.1016/j.ejor.2015.07.056}{10.1016/j.ejor.2015.07.056}.}

\bibitem[\citeproctext]{ref-doyen2011}
\CSLLeftMargin{{[}21{]} }%
\CSLRightInline{L. Doyen and O. Gaudoin, {``Modeling and assessment of
aging and efficiency of corrective and planned preventive
maintenance,''} \emph{IEEE Transactions on Reliability}, vol. 60, no. 4,
pp. 759--769, 2011, doi:
\href{https://doi.org/10.1109/TR.2011.2171115}{10.1109/TR.2011.2171115}.}

\bibitem[\citeproctext]{ref-mohtasham2021}
\CSLLeftMargin{{[}22{]} }%
\CSLRightInline{M. Mohtasham, H. Mirzaei-Nasirabad, H. Askari-Nasab, and
B. Alizadeh, {``Truck fleet size selection in open-pit mines based on
the match factor using a MINLP model,''} \emph{Mining Technology}, vol.
130, no. 3, pp. 159--175, 2021, doi:
\href{https://doi.org/10.1080/25726668.2021.1919374}{10.1080/25726668.2021.1919374}.}

\bibitem[\citeproctext]{ref-kang2016}
\CSLLeftMargin{{[}23{]} }%
\CSLRightInline{N. Kang, C. Zhao, J. Li, and J. A. Horst, {``A
...
\emph{International Journal of Production Research}, vol. 54, no. 21,
pp. 6333--6350, 2016, doi:
